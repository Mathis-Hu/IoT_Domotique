...
TOPIC = os.getenv("TOPIC", "light_bulb")  # Topic à modifier par capteur
...
previous_value = "Éteint"  # valeur précédente, surtout utile pour les capteurs de type événement
...
def generate_value():
    ...
    value = None
    delay_min_temp = DELAY_EVENT_MIN
    delay_max_temp = DELAY_EVENT_MAX

    if previous_value == "Allumé":
        value = "Éteint"
        delay_min_temp = DELAY_EVENT_MIN
        delay_max_temp = DELAY_EVENT_MAX
    else:
